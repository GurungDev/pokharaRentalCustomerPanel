...
import otp from "@/animation/otp.json";
const ForgotPassword = () => {
  ...
  return (
    <main className="relative    m-auto h-full ">
      <div className=" lg:w-[40%] py-24   m-auto h-full ">
        <div className={`${otpForm ? "block" : "hidden"}`}>
          <Form {...OTPform}>
            <form
              className="  grid gap-7  my-5 py-20 px-20 "
      ...
      <div className="absolute z-[-2] w-[30vw] top-[10%] left-[50%] md:top-[40%] md:left-[0%]">
